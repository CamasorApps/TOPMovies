                ...
                onPressed: () {
                  if (user!.isAnonymous) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text(
                          'This syncing feature is only available for signed in users. Register to TOPMovies to synchronize your bookmarked movies and tv shows so that you won\'t lose them.',
